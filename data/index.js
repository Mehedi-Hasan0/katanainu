export const aboutKatanaInu = [
  {
    text: "Katana Inu is an on-chain multiplayer free-2-play and earn game featuring fast paced sword and spell fighting.",
  },
  {
    text: "Set in a third-person perspective, Katana Inu immerses players in fast-paced combat, wielding katanas and unleashing powerful spells. Tthe game focuses on a Play-To-Own approach, enticing gamers from Web2 to embrace the Web3 revolution while providing an exceptional and fair gaming experience. All in-game skins and spells are purely cosmetic, ensuring a level playing field.",
  },
  {
